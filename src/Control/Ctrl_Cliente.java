...
public class Ctrl_Cliente {
    ...
    private static final Logger LOGGER = Logger.getLogger(Ctrl_Cliente.class.getName());
    ...
    // Solución a FileWriter/PrintWriter Blocker Bugs y System.err
    private void guardar() {
        try (FileWriter fw = new FileWriter(archivo);
             PrintWriter pw = new PrintWriter(fw)) {

            for (Clientes cliente : lstClientes) {
                String linea = cliente.getNombre() + separador
    ...
    // Solución al tipo de retorno ArrayList -> List
    ...
    private void guardarDatosClientes() {
        try (FileWriter fw = new FileWriter("clientes.txt");
            ...
            LOGGER.log(Level.SEVERE, "Error al guardar datos de clientes", e);
        }
    }

    // Solución a FileReader/BufferedReader Blocker Bugs y System.err
    private void leer() {
        try (FileReader fr = new FileReader(archivo);
            ...
            LOGGER.log(Level.SEVERE, "Error al listar datos", e);
        }
    }
}
